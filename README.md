# Leaflet — Minimalist Invoice Maker 📄🌿
...
* **Primary Teal (`#1F6F5F`)**: Used for branding, headers, and primary identity.
* **Secondary Green (`#2FA084`)**: Applied to subheadings and section dividers.
* **Action Mint (`#6FCF97`)**: Reserved for buttons and interactive success states.
* **Workspace Gray (`#EEEEEE`)**: Provides a neutral background to make the invoice paper pop.
...
* ✒️ **Digital Signature**: Authentic-looking signatures using the `Dancing Script` font.
* 📄 **One-Click Export**: Generates high-fidelity, single-page A4 PDFs optimized for print.
